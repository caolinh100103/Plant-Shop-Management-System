 ...
 * @author linh1
 */
@WebServlet(name = "createNewPlantServlet", urlPatterns = {"/createNewPlantServlet"})
public class createNewPlantServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int kq = PlantDAO.createPlant(plantName, price, imgPath, des, status, cateID);
            ...
            if (kq > 0) {
                ...
                request.setAttribute("listCategories", list);
                request.setAttribute("MSG", "Create Unsuccessfully!!!");
                request.getRequestDispatcher("createPlant.jsp").forward(request, response);
            }
        }catch (Exception e) {
            e.printStackTrace();
